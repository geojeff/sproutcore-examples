...
config :flot_oil_spills, :url_prefix => "/sc/flot_oil_spills/"
config :svg_editor, :url_prefix => "/sc/svg_editor/"
...
config :svg_editor, :required => [:sproutcore, "sproutcore/forms" ], :theme => "sproutcore/ace"
