...
require("resources/flow_layout_horizontal_page");
...
TestControls.mainPage = SC.Page.create({
  ...
  mainPane: SC.MainPane.design(SC.Animatable, {
    ...
    split: SC.MasterDetailView.design ({
      ...
      masterView: SC.NavigationView.design({ }),
      detailView: SC.WorkspaceView.design({
        ...
        topToolbar: SC.ToolbarView.design({
          ...
          showMaster: SC.ButtonView.design({
            layout: { left: 7, width: 0, centerY: 0, height: 44 }, 
  ...
  flow_layout_horizontal_page: TestControls.flowLayoutHorizontalPage,
